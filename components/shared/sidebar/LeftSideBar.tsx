...
const LeftSideBar = ({ styles }: LeftSideBarProps) => {
	const sideBarStyles = `max-sm:hidden background-light900_dark200 sticky lg:w-auto flex min-h-full flex-col gap-6 pt-16 sm:px-2 md:px-4 lg:px-6 justify-between pb-10 ${
		styles ? styles : ""
	}`;
